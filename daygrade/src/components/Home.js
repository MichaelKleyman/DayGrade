...
const Home = () => {
  ...
  return (
    <div>
      {!currentUser ? (
        <div>
          <div className='w-full flex items-center py-16 px-4'>
            <div className='p-8 max-w-[1240px] sm:mt-[5px] md:mt-[30px] mt-[10px] mx-auto md:grid grid-cols-3 gap-8'>
              ...
              <div className='col-span-2 p-6 sm:ml-5 ml-2'>
          ...
          <div className='w-full flex items-center justify-center pb-6 sm:mt-[9rem] md:mt-[12rem] mt-[2rem] tracking-widest font-thin'>
